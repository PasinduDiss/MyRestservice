...
/*
TestDeleteLive runs live tests which access the deployed public REST API,
A sequence of POST request following a DELETE request which is followed by a GET request
is implemented where we assert for a success response from the POST request response,  but a 404 'Not Found' from the following
...
func TestDeleteLive(t *testing.T) {
	...
	fmt.Println("Live testing Delete")
